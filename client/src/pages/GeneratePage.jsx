...
export default function GeneratePage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const res = await fetch('http://localhost:5000/api/ai/generate', {
                ...
                credentials: 'include',
                body: JSON.stringify({
                    featureType: "codeGeneration",   // <-- FeatureType for Generate
                    userInput: prompt
                }),
            });
    ...
    return (
        <>
        <Navbar selected="Generate" />
        <SelectedFeature featureName="Generate" />
        <div className="max-w-4xl my-1 mx-auto p-4">
          <h1 className="text-xl font-semibold mb-4">Code Generation</h1>
          <textarea
